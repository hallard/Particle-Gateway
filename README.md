...
### Bill Of Material
Reference to Seeedstudion SKU but can be ordered on any provider, Digikey, Mouser
![BOM](https://raw.githubusercontent.com/hallard/Particle-Gateway/master/Particle-Gateway-BOM.xlsx) file 
